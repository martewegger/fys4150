...
vec accel_func(double M, vec pos_obj1, vec pos_obj2, double beta);
vec ForwardEuler(vec pos_obj1, vec pos_obj2, vec vel, double h, double M, double beta, vec accel_func(double M, vec pos_obj1, vec pos_obj2, double beta));
vec Verlet(vec pos_obj1, vec pos_obj2, vec vel, double h, double M, double beta, vec accel_func(double M, vec pos_obj1, vec pos_obj2, double beta));
double T_end = 1.1;
int N = 1e6;
...
int main(int argc, char *argv[]) {
  ...
  my_solver.Initialize(vx0, vy0, h, T_end, beta);
